...
public void validateAddEmployeeFunctionality() {
	...
	ExcelReader excelPIMData=new ExcelReader(excelPIMpath);
	String firstName=excelPIMData.getData(0, 0, 0);
	String middleName=excelPIMData.getData(0, 0, 1);
	String lastName=excelPIMData.getData(0, 0, 2);
...
public void validateEnteredDataInAddEmployee() {
	...
	middlename=pimpage.captureEnteredValueInFirstName();
	lastname=pimpage.captureEnteredValueInFirstName();
}
